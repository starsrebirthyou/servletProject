...
<style type="text/css">
    ...
    .status-badge { font-size: 0.85rem; padding: 5px 12px; border-radius: 50px; font-weight: bold; }
    .info-box { background-color: #f8f9fa; border-radius: 8px; padding: 15px; margin: 15px 0; }
    .info-label { color: #6c757d; font-size: 0.9rem; margin-bottom: 5px; }
    .info-value { font-weight: bold; font-size: 1.1rem; }
    .step-text { font-size: 0.9rem; font-weight: bold; color: #198754; }
    .step-dim { color: #dee2e6; }
</style>
...
$(function(){
    ...
    $("#key .btn[value='" + currentKey + "']").removeClass("btn-outline-success").addClass("btn-success active");
});
</script>
</head>
<body>
        ...
        <div class="res-card" data-no="${vo.resNo}">
            ...
            <div class="row info-box g-0 text-center">
                <div class="col-6 border-end">
                    ...
                    <div class="info-value text-success">${vo.resDate} ${vo.resTime}</div>
                </div>
                <div class="col-6">
...
<c:choose>
    ...
    <c:otherwise>
        <div class="d-flex justify-content-between align-items-center px-2 mb-3">
            ...
            <%-- 화살표: 2 이상이면 활성 --%>
            <span class="${vo.resStatus >= 2 ? 'step-text' : 'step-dim'}">▶</span>
    ...
    <div class="mt-4 mb-5">
        <a href="writeForm.do" class="btn btn-primary">새 예약하기</a>
        <a href="list.do" class="btn btn-outline-secondary">목록 새로고침</a>
    </div>
</div>
