	...
	<div class="container">
		...
		<div id="cancelDiv" class="card card-body bg-light mb-5">
            <form action="delete.do" method="post">
                ...
                <div class="mb-3">
                    <label for="cancelReason" class="form-label text-danger"><strong>취소 사유를 입력해주세요.</strong></label>
                    <textarea class="form-control" id="cancelReason" name="cancelReason" rows="3" required placeholder="예: 개인 사정으로 방문이 어렵습니다."></textarea>
                </div>
