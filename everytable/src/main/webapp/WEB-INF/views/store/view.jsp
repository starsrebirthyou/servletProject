...
<style>
    .alert-custom { background-color: #FFF9E6; border: 1px solid #FFE58F; border-radius: 12px; padding: 20px; color: #856404; }
    .policy-item {
        background: #fff; border: 1px solid #eee; border-radius: 16px; padding: 20px 25px;
    ...
    .p-zero { border-left-color: #E74C3C; } /* ✅ p-0 → p-zero (Bootstrap 충돌 방지) */
    ...
    .b-zero { background: #FEECEC; color: #E74C3C; } /* ✅ b-0 → b-zero (Bootstrap 충돌 방지) */
</style>
        ...
        <div class="tab-pane fade" id="refund-section">
            <div class="p-3">
                <div class="alert-custom mb-4">
                    <h6 class="fw-bold"><i class="fa-solid fa-triangle-exclamation me-2"></i>환불 정책을 꼭 확인하세요!</h6>
                ...
                <div class="policy-item p-zero"> <%-- ✅ p-0 → p-zero --%>
                    <span class="policy-text">픽업 12시간 이내</span>
                    <span class="policy-badge b-zero">${vo.refund_policy_0}</span> <%-- ✅ b-0 → b-zero --%>
                </div>
