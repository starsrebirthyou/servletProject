...
.p-24 {
	border-left-color: #436551;
}

.p-12 {
	border-left-color: #C48A45;
}

.p-zero {
	border-left-color: #E74C3C;
} /* ✅ p-0 → p-zero (Bootstrap 충돌 방지) */
.policy-text {
	font-weight: 700;
	font-size: 1.1rem;
	color: #333;
...
<div class="container mt-5">
	<div class="row align-items-center mb-4">
		...
		<div class="col">
			...
			<h5 class="text-warning">
				★ ${vo.avg_rating} <span class="text-muted">(${vo.review_count}
					리뷰)</span>
			</h5>
		</div>
	...
	<a href="/reservation/writeForm.do?storeId=${vo.store_id}"
		class="btn w-100 py-3 mb-5 fw-bold text-white"
		style="background-color: #c48a45; border-radius: 15px;">주문하기</a>

	<ul class="nav nav-tabs mb-4">
		<li class="nav-item"><a class="nav-link active"
			data-bs-toggle="tab" href="#menu">메뉴</a></li>
		<li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
			href="#refund-section">환불정책</a></li>
	</ul>
		...
		<div class="tab-pane fade" id="refund-section">
			<div class="p-3">
				<div class="alert-custom mb-4">
					<h6 class="fw-bold">
						<i class="fa-solid fa-triangle-exclamation me-2"></i>환불 정책을 꼭
						확인하세요!
					</h6>
				...
				<div class="policy-item p-24">
					<span class="policy-text">픽업 24시간 전</span> <span
						class="policy-badge b-24">${vo.refund_policy_24}</span>
				</div>
				<div class="policy-item p-12">
					<span class="policy-text">픽업 12시간 전</span> <span
						class="policy-badge b-12">${vo.refund_policy_12}</span>
				</div>
				<div class="policy-item p-zero">
					<%-- ✅ p-0 → p-zero --%>
					<span class="policy-text">픽업 12시간 이내</span> <span
						class="policy-badge b-zero">${vo.refund_policy_0}</span>
					<%-- ✅ b-0 → b-zero --%>
				</div>
