...
public class StatsVO {
    ...
    private String statsDate;   // stats_date (통계 날짜 - 추가됨)
 ...
 // --- 추가 필드 (기간 검색 및 요약용) ---
    ...
    private double avgRating;   // 평균 별점 (그날의 리뷰 평균 점수)
    private double totalSum;    // 조회된 기간의 총 매출 합계 (요약 표시용)
 ...
 // --- 추가된 필드의 Getter / Setter ---
    ...
    public String toString() {
        return "StatsVO [statsId=" + statsId + ", statsDate=" + statsDate + ", storeId=" + storeId 
               + ", orderCount=" + orderCount + ", totalSales=" + totalSales + ", avgOrder=" + avgOrder 
